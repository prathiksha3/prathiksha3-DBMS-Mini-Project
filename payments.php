...
$sqlProcedure = "CALL GetPayments()"; // Replace parameters if necessary
$resultProcedure = $conn->query($sqlProcedure);

// Call the function
$sqlFunction = "SELECT GetPaymentCount3(9)"; // Replace 123 with the desired tenant ID
	...
	<div class="col-lg-12">
		...
		<div class="row">
			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						...
						<span class="float:right"><a class="btn btn-sm btn-block btn-info col-sm-2 float-right" href="javascript:void(0)" id="new_payment">
			...
			<div class="col-md-12 mt-4">
				<div class="card">
					<div class="card-header">
						<b>List of Pending Payments</b>
            <a href="pending_payment_details.php" class="btn btn-sm btn-info float-right">View Details</a>
        </div>
					</div>
					<div class="card-body">
						<table class="table table-condensed table-bordered table-hover">
							...
							<tbody>
								...
								while($row = $tenants->fetch_assoc()):
									...
									$pending_payment = ($outstanding > 0) ? number_format($outstanding, 2) : 'N/A';
								?>
								<tr>
									<td class="text-center"><?php echo $i++ ?></td>
									<td class="">
									...
									<td class="">
										 <p><b><?php echo $pending_payment ?></b></p>
									</td>
									<td class="text-center">
										<button class="btn btn-sm btn-outline-primary view_payment" type="button" data-id="<?php echo $row['id'] ?>" >View</button>
									</td>
