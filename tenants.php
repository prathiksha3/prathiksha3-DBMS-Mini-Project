			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						<b>List of Tenant</b>
						<span class="float:right"><a class="btn btn-info btn-block btn-sm col-sm-2 float-right" href="javascript:void(0)" id="new_tenant">
					<i class="fa fa-plus"></i> New Tenant
				</a>
				<a class="btn btn-danger btn-block btn-sm col-sm-2 float-right" href="javascript:void(0)" id="deleted_tenants">
        <i class="fa fa-trash"></i> Deleted Tenants
      </a></span>
					</div>
					<div class="card-body">
...
<script>
	...
	$('#deleted_tenants').click(function(){
    $.ajax({
    url:'fetch_deleted_tenants.php',
    method:'GET',
    success:function(){
        uni_modal("Deleted Tenants","fetch_deleted_tenants.php", "large");
    },
